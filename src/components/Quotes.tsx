...
const personArray: Person[] = [
    ...
    gridClassNameProps: 'lg:col-span-2 col-span-4',
    pHeight: '',
    },
    {id: 1,
    ...
    textColor: 'text-white',
    spanSVG: '',
    gridClassNameProps: 'lg:col-span-1 col-span-4',
    pHeight: 'max-h-20',
    },
    {id: 2,
    name: 'Lilly Harmon',
    ...
    textColor: 'text-black',
    spanSVG: bgQuoteSVGurl,
    gridClassNameProps: 'lg:col-span-1 lg:col-start-4 lg:row-start-1 lg:row-end-3 col-span-4',
    pHeight: '',
    },
]
